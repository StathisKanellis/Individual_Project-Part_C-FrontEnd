...
function insertRecord(data){
    var table=document.getElementById("assignmentPerStudentPerCourse").getElementsByTagName('tbody')[0];
...
function onEdit(td){
    ...
    document.getElementsById("student").value=selectedRow.cells[2].innerHTML;
    document.getElementsById("course").value=selectedRow.cells[3].innerHTML;
    document.getElementsById("Type").value=selectedRow.cells[4].innerHTML;
}
